<template>
    <div class="result-board">
        ...
        <!-- here '==' is used because a_id is integer while id is string -->
        <!-- another way is parseInt($store.state.user.id) -->
        ...
        <div class="result-board-btn">
            <button @click="restart" type="button" class="btn btn-warning btn-large">
                Play Again
            </button>
        </div>
    </div>
...
div.result-board{
    ...
    /* the position is absolute on the screen */
    position: absolute;
    top: 30vh;
    left: 35vw;
}
